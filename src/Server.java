...
public class Server extends Thread {
     ...
     */  
     public void initializeAccounts() {
        ...
        try {
         inputStream = new Scanner(new FileInputStream("/home/anastassy/IdeaProjects/comp_346_assignment_1/src/account.txt"));
        }
     ...
     */
     public boolean processTransactions(Transactions trans) {
         ...
         while (!objNetwork.getClientConnectionStatus().equals("disconnected")) {
             ...
             System.out.println(" Client Connection status: " + objNetwork.getClientConnectionStatus());

             // If the Network buffer is empty, yield the CPU usage
    ...
    public void run() {
        ...
        // Constantly get transactions from the Network buffer
