...
public class Network extends Thread {
    ...
    public void run() {
    	...
    	while (true) {
            ...
            // Disconnect the Network Thread if the client and the server are disconnected
            ...
            // Yield the CPU if the client and the server are still connected
            if (this.getClientConnectionStatus().equals("connected") || this.getServerConnectionStatus().equals("connected")) {
                Thread.yield();
            }
